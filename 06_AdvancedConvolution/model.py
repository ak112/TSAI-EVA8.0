...
class Net(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(32),
            nn.Dropout(dropout_value),  # In: 32x32x3 | Out: 32x32x32 | RF: 3x3
        ...
        self.layer2 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(64),
            nn.Dropout(dropout_value),  # In: 16x16x32 | Out: 16x16x64 | RF: 10x10
        ...
        self.layer3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(64),
            nn.Dropout(dropout_value),  # In: 8x8x64 | Out: 8x8x64 | RF: 24x24
        ...
        self.layer4 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(128),
            nn.Dropout(dropout_value),  # In: 4x4x64 | Out: 4x4x128 | RF: 68x68
